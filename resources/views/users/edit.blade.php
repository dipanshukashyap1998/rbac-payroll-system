...
@section('content')
    <div class="page-shell">
        <section class="page-hero">
            <div>
                <span class="eyebrow"><span class="material-symbols-rounded">manage_accounts</span> Identity maintenance</span>
                <h2>Edit user</h2>
                <p>Adjust role scope, company mapping, and employee-specific details from one refined form.</p>
            </div>
        </section>
