...
@section('content')
    <div class="page-shell">
        <section class="page-hero">
            <div>
                <span class="eyebrow"><span class="material-symbols-rounded">domain_add</span> Onboarding</span>
                <h2>Create company</h2>
                <p>Finish the core company profile so the rest of the portal can unlock for your admin workspace.</p>
            </div>
        </section>
